...
console.log("Algoritmo JS para validação de número de CPF")

let cpfDigitado = "92716480052"

function validaCPF(cpf){
    console.log("CPF Length " + cpf.length)

    if(cpf.length != 11){ //length mostra quantos caracteres tem na string
...
let resultadoCPF = validacao(cpfDigitado)